    ...
    renderBigNav() {
        ...
        if (user) {
            return <ul className="right hide-on-med-and-down">
                ...
                <li><Link to="/cart" className="navi-link"><i className="material-icons">shopping_cart</i> Cart: 0</Link></li>
            </ul>;
        }
        return <ul className="right hide-on-med-and-down">
            <li><Link to="/" className="navi-link">Home</Link></li>
        ...
        if (user) {
            return <div className="hide-on-large-only right">
                <ul id="slide-out" className={`sideNav ${sideNavVisible ? 'sideBarVisible' : ''}`}>
                    ...
                    <li><div className="divider"></div></li>
                    <li><Link to="/cart" onClick={() => this.setState({ sideNavVisible: false })} className="navi-link"><i className="material-icons">shopping_cart</i> Cart: 0</Link></li>
                </ul>
