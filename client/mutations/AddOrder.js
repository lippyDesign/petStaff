...
export default gql`
    mutation AddOrder($shippingName:String, $shippingAddress:String, $shippingPhone:String, $shippingEmail:String $billingName:String, $billingAddress:String, $billingPhone:String, $billingEmail:String, $cardNumber:String, $cardExpiration:String, $cardCvv: String, $dateAndTime:String) {
